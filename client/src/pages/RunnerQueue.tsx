...
import { RefreshCw, Truck, CheckCircle, MapPin, Phone, Clock, ChefHat, Package, LogOut, AlertTriangle } from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', background: 'var(--gray-50)' }}>
      ...
      <header className="nav-header">
        <div className="nav-inner">
          ...
          <span style={{ fontSize: 11, color: 'var(--gray-400)', fontFamily: 'var(--font-ui)', marginRight: 4 }}>
      ...
      {/* Stats bar */}
      <div style={{ display: 'flex', borderBottom: '1px solid var(--gray-100)', background: '#fff' }}>
      ...
      {/* Main tabs */}
      <div style={{ display: 'flex', background: '#fff', borderBottom: '1px solid var(--gray-100)', padding: '0 16px' }}>
...
function OrderCard({ order, action, onAction, loading, highlight }: OrderCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Row 4: delivery fee + paid badge + total */}
